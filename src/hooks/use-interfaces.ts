...
export default function useInterfaces(): {
    mutate: <MutationData = LigoloInterfaces>(data?: (Promise<LigoloInterfaces | undefined> | MutatorCallback<LigoloInterfaces> | LigoloInterfaces), opts?: (boolean | MutatorOptions<LigoloInterfaces, MutationData>)) => Promise<LigoloInterfaces | MutationData | undefined>;
    loading: boolean;
    ...
    } = useSWR<LigoloInterfaces>(`${auth?.api}/interfaces`, url => fetchWithToken(url, auth?.authToken), {
